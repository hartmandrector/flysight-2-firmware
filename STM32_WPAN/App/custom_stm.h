...
typedef enum
{
  ...
  CUSTOM_STM_SD_BARO_MEASUREMENT,
  CUSTOM_STM_SD_HUM_MEASUREMENT,
  CUSTOM_STM_SD_ACCEL_MEASUREMENT,
  CUSTOM_STM_SD_GYRO_MEASUREMENT,
  CUSTOM_STM_SD_MAG_MEASUREMENT,
  /* Starter_Pistol */
...
typedef enum
{
  ...
  /* SD_BARO_Measurement */
  CUSTOM_STM_SD_BARO_MEASUREMENT_READ_EVT,
  CUSTOM_STM_SD_BARO_MEASUREMENT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_BARO_MEASUREMENT_NOTIFY_DISABLED_EVT,
  /* SD_HUM_Measurement */
  CUSTOM_STM_SD_HUM_MEASUREMENT_READ_EVT,
  CUSTOM_STM_SD_HUM_MEASUREMENT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_HUM_MEASUREMENT_NOTIFY_DISABLED_EVT,
  /* SD_ACCEL_Measurement */
  CUSTOM_STM_SD_ACCEL_MEASUREMENT_READ_EVT,
  CUSTOM_STM_SD_ACCEL_MEASUREMENT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_ACCEL_MEASUREMENT_NOTIFY_DISABLED_EVT,
  /* SD_GYRO_Measurement */
  CUSTOM_STM_SD_GYRO_MEASUREMENT_READ_EVT,
  CUSTOM_STM_SD_GYRO_MEASUREMENT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_GYRO_MEASUREMENT_NOTIFY_DISABLED_EVT,
  /* SD_MAG_Measurement */
  CUSTOM_STM_SD_MAG_MEASUREMENT_READ_EVT,
  CUSTOM_STM_SD_MAG_MEASUREMENT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_SD_MAG_MEASUREMENT_NOTIFY_DISABLED_EVT,
  /* SP_Control_Point */
...
extern uint8_t SizeSd_Baro_Measurement;
extern uint8_t SizeSd_Hum_Measurement;
extern uint8_t SizeSd_Accel_Measurement;
extern uint8_t SizeSd_Gyro_Measurement;
extern uint8_t SizeSd_Mag_Measurement;
